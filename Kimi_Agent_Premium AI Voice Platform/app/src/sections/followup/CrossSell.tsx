...
import { ArrowRight, UserSearch, HandshakeIcon, CalendarCheck, Headphones } from 'lucide-react'
...
const agents = [
  ...
  },
  {
    ...
    description: 'Gestion inteligente de citas',
    icon: CalendarCheck,
