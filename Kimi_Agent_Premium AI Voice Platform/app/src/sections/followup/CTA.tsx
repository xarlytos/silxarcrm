  ...
  return (
    <section className="relative py-[100px] lg:py-[120px] overflow-hidden">
      ...
      <div className="relative z-10 max-w-[800px] mx-auto px-6 lg:px-12 text-center" ref={ref}>
        ...
        >
          Recupera el dinero que ya es tuyo
        </motion.h2>
        ...
        >
          Tu Follow-Up Agent estara recuperando oportunidades en 24 horas. 14 dias gratis. Sin tarjeta de credito.
        </motion.p>
        ...
        >
          14 dias gratis &bull; Estimacion de revenue incluida &bull; Sin permanencia
        </motion.p>
      </div>
    </section>
  )
