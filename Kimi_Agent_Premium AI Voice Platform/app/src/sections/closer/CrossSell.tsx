...
import { ArrowRight, Phone, Repeat, Calendar, Headphones } from 'lucide-react'
...
const agents = [
  {
    ...
    path: '/sdr-agent',
    icon: Phone,
    description: 'Prospecta, cualifica y agenda reuniones automaticamente.',
...
export default function CrossSell() {
  return (
    <section className="bg-bg-elevated" style={{ padding: '100px 0' }}>
      <div className="max-w-[1280px] mx-auto px-6 lg:px-12">
        ...
        >
          Completa tu equipo de ventas IA
        </motion.h2>
